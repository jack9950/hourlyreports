...
import logging
logging.basicConfig(filename='C:\\Users\\Jackson.Ndiho\\Documents\\Sales\\mylog.log',level=logging.DEBUG)
...
#   traceback.print_exception(ex)
  # wait = input("PRESS ENTER TO CONTINUE Exception: .")
# wait = input("PRESS ENTER TO CONTINUE6.")
#Open Bounce Sonar page
